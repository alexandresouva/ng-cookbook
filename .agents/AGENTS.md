# Project Coding Guidelines Index

Before writing or modifying any code in this repository, locate and read the relevant guidelines for your task:

## 🚨 CRITICAL / MUST ALWAYS APPLY

1. **Antigravity Workflow & Git Conventions (RTK)**:
