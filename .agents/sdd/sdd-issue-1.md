...
*   **Comando de Instalação:**
    ```bash
    npm install -D eslint@^9.39.2 prettier@^3.8.1 angular-eslint@21.2.0 eslint-config-prettier@^10.1.8 eslint-plugin-prettier@^5.5.5 eslint-plugin-import@^2.32.0 husky@^9.1.7 lint-staged@^16.2.7 @commitlint/cli@^20.4.1 @commitlint/config-conventional@^20.4.1
    ```
*   **Scripts a adicionar:**
    ```json
    "lint": "eslint .",
