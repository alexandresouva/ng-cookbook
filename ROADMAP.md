...
- [ ] **Organização de Pastas Feature-Based** (Conforme [architecture.md](file:///Users/alexandre/Desktop/playground/ng-cookbook/docs/architecture.md))
- [ ] **Configurações de Paths/Aliases** (`tsconfig.json`)
